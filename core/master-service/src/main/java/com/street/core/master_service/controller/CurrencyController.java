...
import com.street.core.master_service.request.CurrencyRequest;
import com.street.core.auth_service.response.ApiResponse;
import com.street.core.master_service.service.CurrencyService;
...
public class CurrencyController {
    ...
    public ResponseEntity<ApiResponse> update(@PathVariable("id") Long id, @RequestBody CurrencyRequest req) {
