...
import com.street.core.exception.NotFoundException;
...
import com.street.core.entity.response.ChildrenPageResponse;
import com.street.core.entity.response.PermissionResponse;
import com.street.core.entity.response.RoleResponseEntity;
...
import com.street.core.request.ChildrenPermissionRequest;
import com.street.core.request.PermissionRequest;
import com.street.core.request.RoleRequest;
...
public class RoleService {
    ...
    public ApiResponse getRole(Long id) {
        ...
        RoleResponseEntity data = RoleResponseEntity.builder().id(role.getId()).name(role.getName())
                .desc(role.getDesc()).build();
    ...
    public ApiResponse createRole(RoleRequest req) {
        ...
        try {
            Optional<RoleEntity> optionalRole = roleRepo.findByName(req.getName());
            if (optionalRole.isPresent()) {
